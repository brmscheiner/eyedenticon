...
esmProdConfig.output = Object.assign({}, esmConfig.output, {
    file: 'dist/mjs/eyedenticon.min.mjs',
    sourcemap: false
});
...
umdProdConfig.output = Object.assign({}, umdConfig.output, {
    file: 'dist/umd/eyedenticon.min.js',
    sourcemap: false
});
...
if (process.env.SERVE) {
    ...
    serveConfig.output = Object.assign({}, commonConfig.output, {
        file: 'dist/render/eyedenticon.iife.js',
        format: 'iife'
    });
    serveConfig.plugins = [
        eslint({
